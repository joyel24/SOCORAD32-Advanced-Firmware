...
void uartChannelSetting()
{
    ...
    {
        if(gRxCtcss < 0) gRxCtcss = 0;
        else if(gRxCtcss > 39) gRxCtcss = 39;

        if(gTxCtcss < 0) gTxCtcss = 0;
        else if(gTxCtcss > 39) gTxCtcss = 39;
         
        uartTxBuf[30] = gCtcssList[gRxCtcss1][0];
        uartTxBuf[31] = gCtcssList[gRxCtcss1][1];
    }
    if(uartTxBuf[33] == 'T' && uartTxBuf[34] == 'C')
    {
        uartTxBuf[33] = gCtcssList[gTxCtcss1][0];
        uartTxBuf[34] = gCtcssList[gTxCtcss1][1];
    }
    if(uartTxBuf[36] == 'B')
    {
